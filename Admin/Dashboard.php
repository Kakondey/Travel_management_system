            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="Dashboard.php">Travel Management System </a>
                        ...
                        <div class="content" style="margin-left: 50px;">
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    <a href="lists/Travel_list.php" class="btn-box big span4"><i class="icon-group"></i>
                                        <p class="text-muted">
                                            List Travel</p>
                                    </a>
                            ...
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a class="collapsed" data-toggle="collapse" href="#togglePages"><i class="menu-icon icon-tasks">
                                    ...
                                    <ul id="togglePages" class="collapse unstyled">
                                        <li><a href="forms/Add_new_Travel.php"><i class="icon-group"></i>Add new Travel</a></li>
                                    </ul>
                                </li>
                            </ul>
                            <!--/.widget-nav-->
